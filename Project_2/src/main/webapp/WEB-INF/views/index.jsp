				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
							<a href="index.html">
								<img class="img-fluid logo" src="/static/images/Poly.png" alt="">
							</a>
						</div>
					...
					<div class="row small-gutters">
						<div class="col-lg-8 top-post-left">
							<div class="feature-image-thumb relative">
								...
								<img class="img-fluid" src="/static/images/top-post1.jpg" alt="">
							</div>
						...
						<div class="col-lg-4 top-post-right">
							<div class="single-top-post">
								<div class="feature-image-thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="/static/images/top-post2.jpg" alt="">
								</div>
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="#">Food Habit</a></li>
							...
							<div class="single-top-post mt-10">
								<div class="feature-image-thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="/static/images/top-post3.jpg" alt="">
								</div>
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="#">Food Habit</a></li>
							...
							<div class="latest-post-wrap">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/static/images/l1.jpg" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/static/images/l2.jpg" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/static/images/l3.jpg" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/static/images/l4.jpg" alt="">
										</div>
										<ul class="tags">
								...
								<div class="relavent-story-list-wrap">
									<div class="single-relavent-post row align-items-center">
										<div class="col-lg-5 post-left">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="/static/images/r1.jpg" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Lifestyle</a></li>
											</ul>
									...
									<div class="single-relavent-post row align-items-center">
										<div class="col-lg-5 post-left">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="/static/images/r2.jpg" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Science</a></li>
											</ul>
									...
									<div class="single-relavent-post row align-items-center">
										<div class="col-lg-5 post-left">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="/static/images/r3.jpg" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Travel</a></li>
											</ul>
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								<div class="single-sidebar-widget editors-pick-widget">
									...
									<div class="editors-pick-post">
										<div class="feature-img-wrap relative">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="/static/images/e1.jpg" alt="">
											</div>
											<ul class="tags">
												<li><a href="#">Travel</a></li>
											</ul>
										...
										<div class="post-lists">
											<div class="single-post d-flex flex-row">
												<div class="thumb">
													<img src="/static/imgaes/e2.jpg" alt="">
												</div>
												<div class="detail">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="/static/images/sidebar-ads.jpg" alt="">
								</div>
								...
								<div class="single-sidebar-widget most-popular-widget">
									...
									<div class="single-list flex-row d-flex">
										<div class="thumb">
											<img src="/static/images/m4.jpg" alt="">
										</div>
										<div class="details">
											<a href="image-post.html">
												<h6>5 Tips For Offshore Soft
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 single-footer-widget">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="/static/images/i1.jpg" alt=""></li>
							<li><img src="/static/images/i2.jpg" alt=""></li>
							<li><img src="/static/images/i3.jpg" alt=""></li>
							<li><img src="/static/images/i4.jpg" alt=""></li>
							<li><img src="/static/images/i5.jpg" alt=""></li>
							<li><img src="/static/images/i6.jpg" alt=""></li>
							<li><img src="/static/images/i7.jpg" alt=""></li>
							<li><img src="/static/images/i8.jpg" alt=""></li>
						</ul>
					</div>
				</div>
