							...
							<div class="editors-pick-post">
								...
								<div class="details">
									...
									<ul class="meta">
										...
										<li><a href="#"><span class="fa fa-eye" aria-hidden="true"></span> ${top1Viewer.countViewer}</a></li>
									</ul>
									...
									<div class="single-post d-flex flex-row">
										...
										<div class="detail">
											...
											<ul class="meta">
												...
												<li><a href="#"><span class="fa fa-eye" aria-hidden="true"></span> ${n.countViewer}</a></li>
											</ul>
										</div>
