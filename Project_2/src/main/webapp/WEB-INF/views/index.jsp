...
<body>
					...
					<div class="single-service d-flex flex-row">
						...
						<div class="details">
							...
							<p>Here, I focus on a range of items and features that we use
								in life without giving them a second thought such as Coca Cola.
							</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="single-service d-flex flex-row">
						...
						<div class="details">
							...
							<p>Over 92% of computers are infected with Adware and
								spyware. Such software is rarely accompanied by uninstall
								utility.</p>
						</div>
					</div>
				</div>
					...
					<div class="single-service d-flex flex-row">
						...
						<div class="details">
							...
							<p>If you own an Iphone, you’ve probably already worked out
								how much fun it is to use it to watch movies-it has that nice
								big screen.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 no-padding info-right">
					...
					<div class="row no-gutters">
						<div class="single-services col">
							<span class="lnr lnr-diamond"></span> <a href="#">
						...
						<div class="single-services col">
							<span class="lnr lnr-phone"></span> <a href="#">
								<h4>Great Support</h4>
							</a>
							<p>Usage of the Internet is becoming more common due to rapid
								advancement of technology.</p>
	...
	<section class="feedback-area section-gap" id="feedback">
		<div class="container">
			...
			<div
				class="row feedback-contents justify-content-between align-items-center">
					...
					<div class="mn-accordion" id="accordion">
						...
						<div class="accordion-item">
							...
							<div class="accordion-content">
								<p>For many of us, our very first experience of learning
									about the celestial bodies begins when we saw our first full
									moon in the sky. It is truly a magnificent view even to the
									naked eye. If the night is clear, you can see amazing detail of
									the lunar surface just star gazing on in your back yard.</p>
							</div>
						</div>
						<!--Accordion item-->
						<!--Accordion item-->
				...
				<div
					class="col-lg-5 feedback-right relative d-flex justify-content-center align-items-center">
					<div class="overlay overlay-bg"></div>
					<a class="play-btn"
						href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img
						class="img-fluid" src="img/play-btn.png" alt=""></a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="active-testimonial">
					...
					<div class="single-testimonial item d-flex flex-row">
						...
						<div class="desc">
							<p>Hypnosis quit smoking methods maintain caused quite world
								over the last two decades. There is a lot of argument pertaining
								to</p>
